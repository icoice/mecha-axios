(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MechaAxios"] = factory();
	else
		root["MechaAxios"] = factory();
})(global, () => {
...
module.exports = {
  ...
  serial: __webpack_require__(4003),
  serialOrdered: __webpack_require__(5566)
};
...
var defer = __webpack_require__(4191); // API
...
var async = __webpack_require__(7235),
    abort = __webpack_require__(1778); // API
...
var abort = __webpack_require__(1778),
    async = __webpack_require__(7235); // API
...
var iterate = __webpack_require__(986),
    initState = __webpack_require__(4772),
    terminator = __webpack_require__(491); // Public API
...
var serialOrdered = __webpack_require__(5566); // Public API
...
module.exports = __webpack_require__(5642);
...
var utils = __webpack_require__(7320);

var settle = __webpack_require__(1135);

var buildFullPath = __webpack_require__(6028);

var buildURL = __webpack_require__(5610);

var http = __webpack_require__(3685);

var https = __webpack_require__(5687);

var httpFollow = (__webpack_require__(5456).http);

var httpsFollow = (__webpack_require__(5456).https);

var url = __webpack_require__(7310);

var zlib = __webpack_require__(5206);

var VERSION = (__webpack_require__(8725).version);

var transitionalDefaults = __webpack_require__(4509);

var AxiosError = __webpack_require__(7624);
...
var cookies = __webpack_require__(4448);

var buildURL = __webpack_require__(5610);

var buildFullPath = __webpack_require__(6028);

var parseHeaders = __webpack_require__(9077);

var isURLSameOrigin = __webpack_require__(1734);
...
var parseProtocol = __webpack_require__(8819);
...
var bind = __webpack_require__(9692);

var Axios = __webpack_require__(9108);

var mergeConfig = __webpack_require__(6163);

var defaults = __webpack_require__(1704);
/**
...
axios.CancelToken = __webpack_require__(6476);
axios.isCancel = __webpack_require__(8448);
axios.VERSION = (__webpack_require__(8725).version);
axios.toFormData = __webpack_require__(7010); // Expose AxiosError class

axios.AxiosError = __webpack_require__(7624); // alias for CanceledError for backward compatibility
...
axios.spread = __webpack_require__(5166); // Expose isAxiosError

axios.isAxiosError = __webpack_require__(5099);
...
var InterceptorManager = __webpack_require__(3060);

var dispatchRequest = __webpack_require__(2756);

var mergeConfig = __webpack_require__(6163);

var buildFullPath = __webpack_require__(6028);

var validator = __webpack_require__(7375);
...
var isAbsoluteURL = __webpack_require__(6900);

var combineURLs = __webpack_require__(6787);
/**
...
var transformData = __webpack_require__(4725);

var isCancel = __webpack_require__(8448);
...
var normalizeHeaderName = __webpack_require__(4554);

var AxiosError = __webpack_require__(7624);

var transitionalDefaults = __webpack_require__(4509);

var toFormData = __webpack_require__(7010);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(1107);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __webpack_require__(1312);
  }
...
var defaults = {
  ...
  maxBodyLength: -1,
  env: {
    FormData: __webpack_require__(724)
  },
...
var utils = __webpack_require__(7320); // Headers whose duplicates are ignored by node
...
var bind = __webpack_require__(9692); // utils is a library of generic helper functions non-specific to axios
...
var DelayedStream = __webpack_require__(8261);
...
module.exports = __webpack_require__(4701)(exports);
...
function setup(env) {
  ...
  createDebug.humanize = __webpack_require__(7937);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
  module.exports = __webpack_require__(9796);
} else {
  module.exports = __webpack_require__(2901);
}
...
try {
  ...
  var supportsColor = __webpack_require__(8542);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(495)("follow-redirects");
    } catch (error) {
      /* */
    }
...
var debug = __webpack_require__(7437); // Create handlers that pass events from native requests
...
var CombinedStream = __webpack_require__(8090);
...
var mime = __webpack_require__(5028);

var asynckit = __webpack_require__(7720);

var populate = __webpack_require__(7313); // Public API
...
var db = __webpack_require__(6986);
...
var hasFlag = __webpack_require__(4166);
...
var form_data = __webpack_require__(518);
...
var dateFormat = function dateFormat(params) {
...
var timestamp = function timestamp(param) {
  return new Date(param).getTime();
};
var today = function today(key) {
  var date = new Date();
  var y = date.getFullYear();
  var m = date.getMonth() + 1;
  var d = date.getDate();
...
var AxiosInterlayer = /*#__PURE__*/function () {
  ...
  AxiosInterlayer_createClass(AxiosInterlayer, [{
    ...
    value: function autoContentType(data) {
      if (is(data, typeof window === 'undefined' ? (form_data_default()) : FormData)) return 'multipart/form-data';
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 25:
                ...
                if (is(payloadData, File)) {
                  ...
                  if (!['GET', 'DELETE'].includes(method)) sendQuery = {};
                  if (!['POST', 'PUT', 'PATCH'].includes(method)) sendBody = {}; // 参数描述（优先级较低）
    ...
    value: function resetPayloadData() {
      ...
      var needChagneTypes = ['todayStart', 'todayEnd', 'todayStartTimestamp', 'todayEndTimestamp', 'today-start', 'today-end', 'today-start-timestamp', 'today-end-timestamp'];
      var canNotChagneTypes = [null, '', undefined];
      var nextData = {};

      var changeDataType = function changeDataType(param) {
      ...
      if (!is(data, 'object') || !is(paramMap, 'array')) return nextData; // data为object时
