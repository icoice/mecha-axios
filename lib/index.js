...
var browser = __webpack_require__(917);
...
var is = function is(v) {
  ...
  if (t === 'object') return _typeof(v) === 'object' && v !== null && !(v instanceof Array);
  if (t === 'promise' || t === Promise) return v instanceof Promise || _typeof(v) === 'object' && v !== null && typeof v.then === 'function' && typeof v["catch"] === 'function';
...
var AxiosInterlayer = /*#__PURE__*/function () {
  function AxiosInterlayer() {
    ...
    _classCallCheck(this, AxiosInterlayer);

    return this.init(options);
  }

  _createClass(AxiosInterlayer, [{
    key: "init",
    value: function init(_ref) {
      ...
      this.proxy = def(proxy, null); // callback
      ...
      this.onDownloadProgress = def(onDownloadProgress, null); // fake
    ...
    value: function buildRequest(item) {
      ...
      var apiRequest = function apiRequest(payload) {
        console.error((browser_default()));
        var abort = new (browser_default())();
        var space = {
          abort: abort
        };
